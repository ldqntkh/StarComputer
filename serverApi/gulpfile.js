...
// need install npm install gulp-multi-dest --save
// need install npm install --save-dev gulp-minify
	
var cartridgePaths = {
	'myBitboxClient' : {
		scss: {
			src: './private/scss/client/*.scss',
			dest: './public/stylesheets/client'
		},
		js: {
			src: './private/js/client/app.js',
			dest: './public/javascripts/client'
		}
	},
	'myBitboxAdmin' : {
		scss: {
			src: './private/scss/admin/*.scss',
			dest: './public/stylesheets/admin'
		},
		js: {
			src: './private/js/admin/app.js',
			dest: './public/javascripts/admin'
		}
	}
}
...
gulp.task('cssMinify', function() {
  return gulp.src('./app_pandora_cn/cartridge/static/default/css/*.css')
    .pipe(minifyCss({keepBreaks:true}))
	.pipe(gulp.dest(cartridgePaths.app_pandora_cn.scss.dest))
});
