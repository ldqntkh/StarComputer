...
?>
        ...
        <div class="list-showrooms">
            ...
            ?>
                <p class="showroom-item <?php if ($item["default"]) echo "default" ?>">
                    ...
                    <span>Xem bản đồ: <strong class="show-map" data="<?php echo $index++; ?>">CLICK</strong></span>
                </p>
            <?php
                endforeach;
            ?>
        </div>
        <div id="list_address_store">
        </div>
    </div>
    <script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $google_map_key; ?>&libraries=geometry">
    </script>
<?php
