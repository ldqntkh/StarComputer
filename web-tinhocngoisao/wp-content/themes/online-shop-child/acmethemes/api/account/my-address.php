...
function add_adress_func() {
  ...
  $otherAddr = get_user_meta( $customer_id, 'multiple_shipping_addresses', true );
  $errors = validate_address_checkout();
...
add_action( 'wp_ajax_update_address', 'update_address', 20 );
