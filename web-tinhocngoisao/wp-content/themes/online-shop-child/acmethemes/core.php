...
function online_shop_scripts_head() {
    ...
    wp_enqueue_script('online-shop-custom-app', get_stylesheet_directory_uri() . '/assets/js/app.js', array('jquery'), '1.0.5', 1);
}
...
function online_shop_scripts() {
    ...
    wp_enqueue_style( 'custom-style', get_stylesheet_directory_uri(). '/custom-style.css', array(), '1.2.9' );
	/*jquery start*/
